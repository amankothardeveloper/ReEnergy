import Banner from "@/app/(component_)/Banner";
                                ...
                                <div className="main-sidebar">
                                    <div className="single-sidebar-widget">
                                        ...
                                        <div className="widget-categories">
                                            <ul>
                                                <li>
                                                    <a href="service-details.html">Cleaning Solution</a>
                                                    <i className="fa-solid fa-arrow-right-long" />
                                                </li>
                                                <li>
                                                    <a href="service-details.html">Plumbing Solution</a>
                                                    <i className="fa-solid fa-arrow-right-long" />
                                                </li>
                                                <li className="active">
                                                    <a href="service-details.html">Air Conditioning</a>
                                                    <i className="fa-solid fa-arrow-right-long" />
                                                </li>
                                                <li>
                                                    <a href="service-details.html">Electricity Solution</a>
                                                    <i className="fa-solid fa-arrow-right-long" />
                                                </li>
                                                <li>
                                                    <a href="service-details.html">Mechanic Solution</a>
                                                    <i className="fa-solid fa-arrow-right-long" />
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        style={{ backgroundImage: 'url("https://reenergy.baseecom.com/assets/img/service/post.jpg")' }}
                                    >
                            ...
                            <div className="col-12 col-lg-8 order-1 order-md-2">
                                <div className="service-details-items">
                                    <div className="details-image">
                                        <img src="https://reenergy.baseecom.com/assets/img/service/details-1.jpg" alt="img" />
                                    </div>
                                    <div className="details-content">
                                        ...
                                        <div className="details-video-items">
                                            <div className="video-thumb">
                                                <img src="https://reenergy.baseecom.com/assets/img/service/details-video.jpg" alt="img" />
                                            ...
                                            <div className="content">
                                                ...
                                                <p>
                                                    {" "}
                                                    Fusce is eleifend porta arcu In hac <br /> habitasse the
                                                    platea thelorem
                                                </p>
                                                <ul className="list">
                                                    <li>
                                        ...
                                        <div className="image-area">
                                            <div className="row g-4">
                                                <div className="col-lg-6 col-md-6">
                                                    <div className="thumb">
                                                        <img src="https://reenergy.baseecom.com/assets/img/service/details-2.jpg" alt="img" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 col-md-6">
                                                    <div className="thumb">
                                                        <img src="https://reenergy.baseecom.com/assets/img/service/details-3.jpg" alt="img" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <p className="mt-3">
                                            The is ipsum dolor sit amet consectetur adipiscing elit. Fusce
                                            is eleifend porta arcu In hac habitasse the platea thelorem
                                            turpoi dictumst. In lacus libero faucibus malesuada.
                                        </p>
                                    </div>
