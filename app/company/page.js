  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: 'url("https://reenergy.baseecom.com/assets/img/breadcrumb.jpg")' }}
      >
        <div className="border-shape">
          <img src="https://reenergy.baseecom.com/assets/img/element.png" alt="shape-img" />
        </div>
        <div className="line-shape">
          <img src="https://reenergy.baseecom.com/assets/img/line-element.png" alt="shape-img" />
        </div>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("https://reenergy.baseecom.com/assets/img/service/service-bg-2.jpg")',
        }}
      >
        <div className="container">
              ...
              <div className="col-lg-6">
                <div className="about-image-items">
                  <div className="circle-shape">
                    <img src="https://reenergy.baseecom.com/assets/img/about/circle.png" alt="shape-img" />
                  </div>
                  ...
                  <div
                    ...
                    data-wow-delay=".3s"
                    style={{
                      backgroundImage: 'url("https://reenergy.baseecom.com/assets/img/about/03.png")',
                      visibility: "visible",
                      animationDelay: "0.3s",
              ...
              <div className="col-lg-6 mt-4 mt-lg-0">
                <div className="about-content">
                  ...
                  <div className="about-author">
                    ...
                    >
                      <img src="https://reenergy.baseecom.com/assets/img/about/author.png" alt="author-img" />
                      <div className="content">
                ...
                <div className="icon">
                  ...
                  >
                    <g clipPath="url(#clip0_2517_1783)">
                      <path
                        d="M25.3682 0.727224L25.3303 0L24.6066 0.0778922C24.5356 0.0854747 17.5397 0.928503 17.06 8.75012L17.0117 9.53318L17.7948 9.48011C17.8747 9.47459 25.7984 8.84249 25.3682 0.727224ZM24.0027 1.60058C23.8711 6.3141 20.2039 7.62517 18.5206 7.97878C19.1617 3.39831 22.4835 2.00245 24.0027 1.60058Z"
                        fill="white"
                      />
                      <path
